...
export default function Dashboard(props) {
  ...
  {products.map(({ id, nombre, descripcion, precio, usuario, eventa, reporte, usuariov, imagen }) => (
    ...
    <li class="flex flex-row">
      <div class="select-none cursor-pointer hover:bg-gray-50 flex flex-1 items-center p-4">
        ...
        <div class="flex flex-row justify-center">
          <div class="text-gray-600 dark:text-gray-200 text-xs">{eventa}</div>
  ...
  {products.length === 0 && (
                                        <tr>
                                            <td
                                                ...
                                                colSpan="4"
                                            >
                                               <h1> No se han encontrado vender.
                                               ¡Empieza a vender!  <br/>
                                                    </h1>
